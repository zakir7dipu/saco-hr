...
class FeaturesController extends Controller
{
    ...
    public function features_store(Request $request){
        ...
        return redirect()->back()->with(['success'=> 'Feature Block add successfully']);
    }
    ...
    public function features_update(Request $request, $key){
        ...
        return redirect()->back()->with(['success'=> 'Feature Block updated successfully']);
    }
    ...
    public function features_delete($key){
        ...
        return redirect()->back()->with(['success'=> 'Feature Block deleted successfully']);
    }
}
