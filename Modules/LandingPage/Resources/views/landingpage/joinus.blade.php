                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('joinus_heading', $settings['joinus_heading'], ['class' => 'form-control', 'placeholder' => __('Enter Heading')]) }}
                                        @error('mail_port')
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span>
                                                                ...
                                                                {!! Form::open(['method' => 'DELETE', 'route' => ['join_us.destroy', $value->id],'id'=>'delete-form-'.$key]) !!}
