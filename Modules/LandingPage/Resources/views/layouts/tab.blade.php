    ...
    <a href="{{ route('discover.index') }}" class="list-group-item list-group-item-action border-0 {{ (Request::route()->getName() == 'discover.index') ? ' active' : '' }}">{{ __('Discover') }} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
