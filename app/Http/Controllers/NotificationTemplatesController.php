...
class NotificationTemplatesController extends Controller
{
    public function index($id = null, $lang = 'en')
    {
        if(\Auth::user()->type == 'company')
        {
            ...
            return view('notification-templates.index', compact('notification_template','notification_templates','curr_noti_tempLang','languages'));
        }
        else
        {
    ...
    public function update(Request $request,$id)
    {
        ...
        // $NotiLangTemplate = NotificationTemplateLangs::where('parent_id', '=', $id)->where('lang', '=', $request->lang)->first();
