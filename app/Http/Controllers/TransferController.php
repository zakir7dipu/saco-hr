...
class TransferController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(\Auth::user()->can('Create Transfer'))
        {
            ...
            $transfer->branch_id     = !empty($request->branch_id) ? $request->branch_id : '';
            $transfer->department_id = !empty($request->department_id) ? $request->department_id : '';
            $transfer->transfer_date = $request->transfer_date;
            $transfer->description   = !empty($request->description) ? $request->description : '';
