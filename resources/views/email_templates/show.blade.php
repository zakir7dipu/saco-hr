                    ...
                    @if ($chatgpt == 'on')
                        <div class="text-end pt-3">
                            <a href="#" class="btn btn-sm btn-primary" data-size="medium" data-ajax-popup-over="true"
                                data-url="{{ route('generate', ['email template']) }}" data-bs-toggle="tooltip"
                            ...
                            @endforeach --}}
                                @foreach (App\Models\Utility::languages() as $code => $lang)
                                    <a href="{{ route('manage.email.language', [$emailTemplate->id, $code]) }}"
                                        class="dropdown-item {{ $currEmailTempLang->lang == $code ? 'text-primary' : '' }}">
                                ...
                                <div class="row text-xs">
                                    ...
                                    @elseif($emailTemplate->slug == 'new_employee')
                                        <div class="row">
                                            ...
                                            <p class="col-4">{{ __('Employee Branch') }} : <span
                                                    class="pull-right text-primary">{employee_branch}</span></p>
                                            <p class="col-4">{{ __('Employee Department') }} : <span
                                                    class="pull-right text-primary">{employee_department}</span></p>
                                            <p class="col-4">{{ __('Employee Designation') }} : <span
                                    ...
                                    @elseif($emailTemplate->slug == 'new_payroll')
                                        <div class="row">
                                            ...
                                            <p class="col-4">{{ __('Salary Month') }} : <span
                                                    class="pull-right text-primary">{salary_month}</span></p>
                                            <p class="col-4">{{ __('URL') }} : <span
                                                    class="pull-right text-primary">{url}</span></p>
                                    ...
                                    @elseif($emailTemplate->slug == 'new_ticket')
                                        <div class="row">
                                            ...
                                            <p class="col-4">{{ __('App Url') }} : <span
                                                    class="pull-right text-primary">{app_url}</span></p>
                                            <p class="col-4">{{ __('Ticket Title') }} : <span
                                                    class="pull-right text-primary">{ticket_title}</span></p>
                                            <p class="col-4">{{ __('Ticket Employee Name') }} : <span
                                                    class="pull-right text-primary">{ticket_name}</span></p>
                                            <p class="col-4">{{ __('Ticket Code') }} : <span
                                                    class="pull-right text-primary">{ticket_code}</span></p>
                                            <p class="col-4">{{ __('Ticket Description') }} : <span
                                    ...
                                    @elseif($emailTemplate->slug == 'contract')
                                        <div class="row">
                                            ...
                                            <p class="col-4">{{ __('Contract Employee') }} : <span
                                                    class="pull-right text-primary">{contract_employee}</span></p>
                                            <p class="col-4">{{ __('Contract Start Date') }} : <span
