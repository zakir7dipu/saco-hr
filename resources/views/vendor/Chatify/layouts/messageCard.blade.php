                ...
                <div>
                    <div class="message-card">
                        <div class="image-file chat-image"
                            style="width: 250px; height: 150px;background-image: url('{{ $profile . '/' . $attachment[0] }}')">
                        </div>
                    </div>
                </div>
            @endif
    ...
    <div class="message-card mc-sender" title="{{ $fullTime }}" data-id="{{ $id }}">
        ...
        <div>
            <div class="message-card mc-sender">
                <div class="image-file chat-image"
                    style="width: 250px; height: 150px;background-image: url('{{ \App\Models\Utility::get_file(config('chatify.attachments.folder').'/'.$attachment[0]) }}')">
                </div>
            </div>
        </div>
        @endif
