        ...
        {{-- @if ((\Auth::user()->type == 'company' && $contract->company_signature == '') || (\Auth::user()->type == 'employee' && $contract->employee_signature == ''))
            @if ($contract->status == 'accept')
                <a href="#" class="btn btn-sm btn-primary btn-icon m-2"
                    ...
                    data-title="{{ __('Signature') }}" data-size="md" title="{{ __('Signature') }}"
                                            ...
                                            <address class="mb-0 text-sm">
                                                <div class="row mt-3 align-items-center">
                                                    ...
                                                    <div class="col-sm-8 text-sm">
                                                        {{ Auth::user()->priceFormat($contract->value) }}</div>

                                                    <div class="col-sm-4 h6 text-sm">{{ __('Start Date') }}</div>
                                                    <div class="col-sm-8 text-sm">
                                                        {{ Auth::user()->dateFormat($contract->start_date) }}</div>

                                                    <div class="col-sm-4 h6 text-sm">{{ __('End Date') }}</div>
                                                    <div class="col-sm-8 text-sm">
                                                        {{ Auth::user()->dateFormat($contract->end_date) }}</div>
                                                ...
                                                <div class="col-12 d-flex">
                                                    ...
                                                    @if (\Auth::user()->type == 'company' || \Auth::user()->type == 'hr')
                                                        <div class="form-group mb-0 form-send w-100">
                                                            ...
                                                            <textarea rows="3" id="formComment" class="form-control" name="comment" data-toggle="autosize"
                                                        ...
                                                        <button id="comment_submit" class="btn b tn-send"><i
                                                    ...
                                                    {{-- @if ($contract->status == 'accept')
                                                        <div class="form-group mb-0 form-send w-100">
                                                            <input type="hidden" id="commenturl"
                                                                value="{{ route('comment.store', $contract->id) }}">
                                                            <textarea rows="1" id="formComment" class="form-control" name="comment" data-toggle="autosize"
                                                                placeholder="Add a comment..." spellcheck="false"></textarea>
                                                            <grammarly-extension data-grammarly-shadow-root="true"
                                                                style="position: absolute; top: 0px; left: 0px; pointer-events: none; z-index: 1;"
                                                                class="cGcvT"></grammarly-extension>
