                    ...
                    <div class="card-body" id="boxes" style="padding: 50px;">
                        <div class="row invoice-title mt-2">
                            <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12 ">
                                ...
                                <img src="{{ $logos . $company_logo .'?'.time() }}" alt="{{ env('APP_NAME') }}" class="logo logo-lg" style="max-height: 100px;" />
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 text-end">
                                <div style="margin-bottom: 20px;">
                                    <img width="200px" src="{{$contract->employee_signature}}" >
                                </div>
                                <div>
...
@push('script-page')
    ...
    <script>
        ...
        $(window).on('load', function () {
            ...
            var opt = {
                filename: '{{$usr->contractNumberFormat($contract->id)}}',
