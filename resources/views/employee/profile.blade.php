                    ...
                    <div class="d-flex align-items-center justify-content-end">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mx-2">
                            <div class="btn-box" id="department_id">
                                ...
                                {{ Form::select('department', $departments, isset($_GET['department']) ? $_GET['department'] : '', ['class' => ' select-width form-control department_id', 'id' => 'department_id', 'placeholder' => 'Select Department']) }}
                        ...
                        <div class="col-auto float-end ms-2 mt-4">
                            <a href="#" class="btn btn-sm btn-primary apply_btn"
