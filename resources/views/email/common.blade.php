                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    <p
                                                                        style="border-top:solid 7px #6676EF;font-size:1;margin:0px auto;width:100%;">
                                                                    </p>

                                                                    <table align="center" border="0" cellpadding="0"
                                                                        cellspacing="0"
                                                                        style="border-top:solid 7px #6676EF;font-size:1;margin:0px auto;width:600px;"
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="width:110px;">
                                                                                    <img alt="" height="auto"
                                                                                        src="{{ $logo . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo.png') }}"
