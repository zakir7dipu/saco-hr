...
{{ Form::model($transferbalance, ['route' => ['transferbalance.update', $transferbalance->id], 'method' => 'PUT']) }}
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::select('from_account_id', $accounts, null, ['class' => 'form-control select2', 'placeholder' => __('Choose Account')]) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('to_account_id', __('To Account'), ['class' => 'col-form-label']) }}
                {{ Form::select('to_account_id', $accounts, null, ['class' => 'form-control select2', 'placeholder' => __('Choose Account')]) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
