    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{ Form::text('purchase_date', null, array('class' => 'form-control d_week','required'=>'required')) }}
                </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{ Form::text('supported_date', null, array('class' => 'form-control d_week','required'=>'required')) }}
                </div>
