        ...
        <div class="container">
            ...
            <div class="row align-items-center justify-content-center mb-5 mobile-screen">
                <div class="col-auto">
                    ...
                    <img src="{{ $logos . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'dark_logo.png') }}"
                        alt="" class="img-fluid" />
                </div>
                <div class="col-auto">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-3 col-lg-6 col-md-12 col-sm-12">
                    <div class="row feature-img-row m-auto">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <img src="{{ asset('landing/hrmgo-saas-pic-4.png') }}"
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <img src="{{ asset('landing/hrmgo-saas-pic-7.png') }}"
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <img src="{{ asset('landing/hrmgo-saas-pic-8.png') }}"
                                class="img-fluid header-img wow animate__fadeInRight mt-5" data-wow-delay="0.7s"
                                alt="Admin" />
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <img src="{{ asset('landing/hrmgo-saas-pic-13.png') }}"
