    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{ Form::select('branch', $branches, null, ['class' => 'form-control select2', 'required' => 'required', 'id' => 'branch_select']) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <div class="employee_div">
                    {{-- <select name="employee" id="employee choices-multiple" class="form-control " required> --}}
